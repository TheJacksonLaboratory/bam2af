...
import org.jax.bam2af.analysis.IntervalAlleleCounter;
...
public class Bam2Af {
    ...
    public static void main(String args[]) {
        String bamSample="src/test/resources/bam/sorted_toy_aln.bam";
        String bedSample="src/test/resources/bam/toy_intervals.bed";
    ...
    public void parseBam() {
        for (GenomicInterval gi : this.bedIntervalList) {
            ...
            IntervalAlleleCounter iac = new IntervalAlleleCounter(iter,chrom,from,to);
        }
